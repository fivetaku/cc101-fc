...
그래서 이 클립에서는 **가능한 분석 관점을 펼친 뒤, 그중 몇 개를 고르는 것**부터 합니다. 예를 들어 위기 진단, 원가 추이, 라인별 매출, 운영 효율, 재고 균형처럼 나뉘면 차트 종류도 자연스럽게 정해져요.
...
차트 생성에는 `pandas`, `matplotlib` 같은 도구가 쓰입니다. 솔직히 도구 이름을 외울 필요는 없어요. AI에게 **데이터 위치**, **보고 싶은 관점**, **저장 위치**, **수정 범위**를 분명히 말하는 게 핵심입니다.
