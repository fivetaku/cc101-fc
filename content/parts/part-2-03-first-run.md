...
여기서 꼭 짚고 넘어갈 게 있어요. Claude Code는 혼자 막 실행하는 도구가 아니라, **STEP 3 확인**에서 사용자의 승인을 받는 도구예요. 이 안전장치를 이해하고 나면 “AI에게 작업을 맡긴다”는 말이 훨씬 덜 막연해져요.
...
이 클립을 마치면 `progress.json`에는 실습 3 완료 상태가 반영됩니다. “첫 실행 성공”보다 “분석 → 판단 → 확인 → 실행” 흐름을 직접 봤다는 게 더 중요해요.
